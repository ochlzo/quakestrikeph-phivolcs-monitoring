...
export const EARTHQUAKE_REVIEW_STATUS_UPDATED_EVENT =
  'quakestrike:earthquake-review-status-updated';
...
export function countActiveMapFilters(filters?: EarthquakeMapFilters) {
  ...
  return [
    ...
    !FORECAST_LIKELIHOODS.every((value) =>
      filters.forecasts.aftershock24hLikelihoods.includes(value),
    ),
